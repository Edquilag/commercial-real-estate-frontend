...
export function Logo({ light = false }: { light?: boolean }) {
  return <Link to="/" className={`logo ${light ? 'text-white' : ''}`} aria-label="EstateHub home"><span className="logo-mark"><Building2 size={24} strokeWidth={1.4} /></span><span>ESTATE<span className="text-clay">HUB</span><small>COMMERCIAL REAL ESTATE</small></span></Link>
}
